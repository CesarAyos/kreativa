...
//     // Obtén el texto del elemento con id "total"
//     const totalTexto = document.getElementById("total").textContent;

//     // Extrae el valor numérico de la cadena (elimina "Total: $" y otros caracteres)
//     const totalNumerico = parseFloat(totalTexto.replace("Total: $", ""));

//     // Redirige al proceso de pago (simulado aquí)
//     alert(`Total a pagar: $${totalNumerico} `);
//     // Aquí deberías redirigir a tu página de pago real
// });
